...
from models.datasensor import DataSensor


class GEOLENSCommand(cmd.Cmd):
    """
    GEOLENSCommand class defines all common attributes/methods for command
    interpreter
    """
    prompt = "(geolens) "
    class_types = ["BaseModel", "Purchase", "Machine", "User", "DataSensor"]
